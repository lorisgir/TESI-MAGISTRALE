...
%% PDF SETTINGS
\hypersetup{
    pdfauthor={Loris Giraudo},
    pdftitle={Master Thesis},
    pdfsubject={Model Selection for Anomaly Detection},
    pdfkeywords={model-selection, anomaly-detection}
}
%% FONTS AND SYMBOLS
...
\input{head/empty.tex}
\clearemptydoublepage
\input{head/declaration}
\clearemptydoublepage
