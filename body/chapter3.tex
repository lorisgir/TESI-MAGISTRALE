...
Deep Support Vector Data Description (DeepSVDD) allena una rete neurale mentre minimizza il volume della iper-sfera che racchiude la rappresentazione della rete sui dati. Minimizzare il volume dell'iper-sfera forza la rete ad estrarre i fattori comuni di variazione dato che la rete deve mappare i punti dei daltaset al centro della sfera. 
\begin{figure}[t]
	\centering
