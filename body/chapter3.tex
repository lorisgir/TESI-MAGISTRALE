...
Ad esempio bisogna tenere in considerazione se c'e' una prevalenza di punti di una classe. Accuracy e' preferibile quando ci si aspetta una distribuzione uguale delle classi. Quando i falsi-negativi non sono di interesse, ma lo sono i falsi-positivi, precision e' preferibile; al contrario quando i falsi-negativi sono molto importanti e non ci interessa dei falsi-positivi, recall e' la scelta corretta.
...
pca, ocsvm, LMDD, autoregressive
\subsection{Distance Based Models}
kmeans, dbscan, lof, 
\subsection{Probabilistic Models}
kde,gmm, sampling, abod, ecod, copod
\subsection{Ensemble Models}
iforest, inne, feature bagging

\section{Neural Network Models}
\subsection{Auto Encoders}
auto, vae
\subsection{LSTM}
lstm, telemanom, DeepLog
\subsection{Adversarial Networks}
anogan

\section{Thresholding}
iqr, z-score, o yGMM del tipo